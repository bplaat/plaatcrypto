...
@section('title', __('transactions.edit.title', ['transaction.name' => $transaction->name]))
...
@section('content')
    <div class="breadcrumb">
        <ul>
            ...
            <li><a href="{{ route('transactions.show', $transaction) }}">{{ $transaction->name }}</a></li>
            <li class="is-active"><a href="{{ route('transactions.edit', $transaction) }}">@lang('transactions.edit.breadcrumb')</a></li>
        </ul>
    </div>

    <h1 class="title">@lang('transactions.edit.header')</h1>
    ...
    <form method="POST" action="{{ route('transactions.update', $transaction) }}">
        ...
        <div class="field">
            <label class="label" for="coin_id">@lang('transactions.edit.coin')</label>
        ...
        <div class="field">
            <label class="label" for="type">@lang('transactions.edit.type')</label>
        ...
        <div class="field">
            <label class="label" for="amount">@lang('transactions.edit.amount')</label>
        ...
        <div class="field">
            <label class="label" for="price">@lang('transactions.edit.price')</label>
        ...
        <div class="columns">
            <div class="column">
                <div class="field">
                    <label class="label" for="date">@lang('transactions.edit.date')</label>
            ...
            <div class="column">
                <div class="field">
                    <label class="label" for="time">@lang('transactions.edit.time')</label>
        ...
        <div class="field">
            <div class="control">
                <button class="button is-link" type="submit">@lang('transactions.edit.button')</button>
            </div>
        </div>
    </form>
@endsection
